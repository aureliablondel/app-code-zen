...
<div class="color-content">
    ...
    <form class="form-signup" action="index.php?action=registerUser&id=<?= $_GET['id'] ?>" method="POST">
        ...
        <div>
            <input type="checkbox" id="rgpd-checkbox" name="rgpd" value="on">
            <label for="rgpd-checkbox">J'accepte la politique de confidentialité du site</label>
            <?php if(isset($errors['cgu-notchecked'])): ?>
            <span class="error"><?= $errors['cgu-notchecked'];?></span>
            <?php endif; ?>
        </div>
        <div class="btn-form">
